  ...
  return (
    <RACSelect {...props} className="noria-select">
      ...
      <Button className="noria-select__button neu-pressed">
        ...
        <span aria-hidden="true" className="noria-select__icon"><ChevronDown size={18} /></span>
      </Button>
      {description && <Text slot="description" className="noria-select__description">{description}</Text>}
...
export const SelectItem = (props: ListBoxItemProps) => {
  return (
    <ListBoxItem {...props} className="noria-select__item" />
  );
}
