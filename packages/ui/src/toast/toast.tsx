...
export const Toast = ({ toast, ...props }: { toast: { content: NoriaToastContent, key: string }, [key: string]: unknown }) => {
  ...
  return (
    ...
    >
      ...
      <ToastContent className="noria-toast-content">
        <span slot="title" className="noria-toast-title">{title}</span>
        {description && <span slot="description" className="noria-toast-description">{description}</span>}
      </ToastContent>
