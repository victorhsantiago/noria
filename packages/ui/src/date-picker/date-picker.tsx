...
export const DatePicker = <T extends DateValue>({
  ...
  return (
    <RACDatePicker {...props} className="noria-date-picker">
      ...
      {description && <Text slot="description" className="noria-date-picker__description">{description}</Text>}
        ...
        <Dialog className="noria-date-picker__dialog">
          <Calendar className="noria-calendar">
            <header className="noria-calendar__header">
              <Button slot="previous" className="noria-calendar__nav-button"><ChevronLeft size={18}/></Button>
              <Heading className="noria-calendar__heading" />
              <Button slot="next" className="noria-calendar__nav-button"><ChevronRight size={18}/></Button>
            </header>
            <CalendarGrid className="noria-calendar__grid">
              <CalendarGridHeader>
                {(day) => <CalendarHeaderCell className="noria-calendar__header-cell">{day}</CalendarHeaderCell>}
              </CalendarGridHeader>
              <CalendarGridBody>
