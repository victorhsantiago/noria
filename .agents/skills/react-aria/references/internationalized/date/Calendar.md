...
| EthiopicAmeteAlemCalendar | `'ethioaa'` | The Ethiopic (Amete Alem) calendar is the same as the modern Ethiopic calendar,
except years were measured from a different epoch. Only one era is supported: 'AA'. |
| CopticCalendar | `'coptic'` | The Coptic calendar is similar to the Ethiopic calendar.
It includes 12 months of 30 days each, plus 5 or 6 intercalary days depending
