...
`useContextProps(props: T & SlotProps, ref: ForwardedRef<E> | undefined, context: Context<ContextValue<U, E>>): [T, RefObject<E | null>]`

### useSlottedContext

`useSlottedContext(context: Context<SlottedContextValue<T>>, slot?: string | null): T | null | undefined`
