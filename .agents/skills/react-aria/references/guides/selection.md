...
function PokemonItem(props: { name: string }) {
	return (
		<GridListItem id={props.name} textValue={props.name}>
			<img
				src={`https://img.pokemondb.net/sprites/home/normal/2x/avif/${props.name.toLowerCase()}.avif`}
				alt=""
			/>
...
<ListBox aria-label="Animated ListBox" selectionMode="single">
...
| `dangerouslySetInnerHTML`        | `{ \_\_html: string                                                                                   | TrustedHTML; }       | undefined`                                                                                                | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |                                                                                            |
...
<GridList>
	...
	<GridListItem onAction={() => alert('Opening "Architecture"')} textValue="Architecture">
		<img
	...
	<GridListItem onAction={() => alert('Opening "Golden Hour"')} textValue="Golden Hour">
		<img
...
<Tree aria-label="Files" selectionMode="multiple" defaultExpandedKeys={['computer']}>
	<TreeItem id="computer" title="My Computer">
		...
		/>
		{/*- end highlight -*/}
		<TreeItem title="Documents" onAction={() => alert('Opening Documents')} />
		<TreeItem title="Photos" onAction={() => alert('Opening Photos')} />
	</TreeItem>
</Tree>;
```
...
>
	{/*- end highlight -*/}
	<TreeItem id="computer" title="My Computer">
		<Collection items={files}>{(item) => <TreeItem title={item.name} />}</Collection>
	</TreeItem>
</Tree>;
```
...
<Table aria-label="Pokemon" selectionMode="multiple">
	<TableHeader>
		<Column isRowHeader>Name</Column>
		<Column>Type</Column>
		<Column>Level</Column>
...
<ListBox aria-label="Pokemon" disabledKeys={[3]} selectionMode="multiple" items={items}>
...
<GridList aria-label="Pokemon" data-size="small" disabledKeys={[3]} items={items}>
	{(item) => (
...
<TagGroup aria-label="Pokemon" selectionMode="multiple" disabledKeys={[3]} items={items}>
...
<Table aria-label="Pokemon" disabledKeys={[3]} selectionMode="multiple">
	<TableHeader>
		<Column isRowHeader>Name</Column>
		<Column>Type</Column>
		<Column>Level</Column>
