...
function Example(props) {
	...
	return (
		<>
			<MenuTrigger>
				<Button>View</Button>
				<Menu {...props} selectedKeys={selected} onSelectionChange={setSelected}>
					{/*- end highlight -*/}
...
```tsx
const CustomTrigger = React.forwardRef((props, ref) => <button {...props} ref={ref} />);
```
